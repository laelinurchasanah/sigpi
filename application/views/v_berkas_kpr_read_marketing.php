        ...
        <table id="example1" class="table table-bordered table-striped table-responsive">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <!-- <a href="<?= base_url('berkas_kpr/delete/' . $bks->id_berkas) ?>" class="btn btn-danger btn-sm"
								onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">
								<i class="fas fa-trash"></i>
							</a> -->
                        <!-- Button modal update status dan isi keterangan -->
                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                            data-target="#updateStatus<?= $bks->id_berkas ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('berkas_kpr/marketingupdate_status/' . $bks->id_berkas) ?>" method="post">
                    <div class="form-group">
                        <label for="status">Status</label>
                        <select name="tstatus" id="status" class="form-control">
                            <!-- Jika status pending, maka selected -->
                            <option value="Pending" <?php if ($bks->status_berkas == "Pending")
									echo "selected" ?>>
                                Menunggu</option>
                            <!-- Jika status diterima, maka selected -->
                            <option value="Diterima" <?php if ($bks->status_berkas == "Diterima")
									echo "selected" ?>>
                                Diterima</option>
                            <!-- Jika status ditolak, maka selected -->
                            <option value="Ditolak" <?php if ($bks->status_berkas == "Ditolak")
									echo "selected" ?>>
                                Ditolak</option>
                        </select>
                    </div>
