            ...
            <div class="form-group" id="data-diri">
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="file" name="tkk" required class="form-control">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label>BPJS</label>
                            <input type="file" name="tbpjs" required class="form-control">
                            <span class="text-danger">*Harap diisi</span>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <span class="text-danger">*Kosongkan jika belum menikah</span>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label>Pas Foto</label>
                            <input type="file" name="tpasfoto" required class="form-control">
